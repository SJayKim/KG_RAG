...
| [`docs/DAY1-3-GATE.md`](./docs/DAY1-3-GATE.md) | **Day 1–3 게이트 검증 결과**(2026-07-04). openFDA 라벨 실측(CYP3A4 축 PASS), 전이 골드 5개, 크로스워크 18성분. **핵심 발견: statin 라벨 co-naming → 진짜 graph-win은 라벨이 상대약을 명시 안 하는 케이스(G1).** 유일 블로커=DUR 키(사용자 발급). |
