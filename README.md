...
| 파일 | 내용 |
|---|---|
| [`DESIGN.md`](./DESIGN.md) | **최종 설계 문서.** 문제정의·그래프 스키마·에이전트 구조·평가 하네스·3주 계획·데이터 수집 계획(라이선스 포함). 적대적 리뷰 2회 통과(8/10). |
...
- ⬜ 구현 시작 전. **다음 행동(Assignment)**은 `DESIGN.md`의 "The Assignment" 섹션 참고.
